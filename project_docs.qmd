...
From the core genome from panaroo, a subset of 150 genes, present in all strains, was extracted to build the phylogenetic tree of the pangenome. Before aligning each gene per separate, as some of them were in multicopy, only one gene per genome was kept for alignment. The alignment was done using mafft @Katoh2013 (v. 7. 526), and the tree was constructed with IQ-Tree (v. 2.3.6) @Nguyen2014 with the GTR+I+G substitution model.
